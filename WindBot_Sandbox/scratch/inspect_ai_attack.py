...
$method = $type.GetMethod("Attack", [System.Reflection.BindingFlags]::Public -bor [System.Reflection.BindingFlags]::Instance -bor [System.Reflection.BindingFlags]::NonPublic -bor [System.Reflection.BindingFlags]::Static)
...
if ($method -ne $null) {
    ...
    Write-Host "Attack method not found"
}
"""

with open("inspect_ai_attack.ps1", "w", encoding="utf-8") as f:
    f.write(ps_script)

res = subprocess.run(["powershell", "-ExecutionPolicy", "Bypass", "-File", "inspect_ai_attack.ps1"], capture_output=True, text=True)
print(res.stdout)

if os.path.exists("inspect_ai_attack.ps1"):
    os.remove("inspect_ai_attack.ps1")
