...
$method = $type.GetMethod("OnPreBattleBetween", [System.Reflection.BindingFlags]::Public -bor [System.Reflection.BindingFlags]::Instance -bor [System.Reflection.BindingFlags]::NonPublic)
...
if ($method -ne $null) {
    ...
    Write-Host "OnPreBattleBetween method not found"
}
"""

with open("inspect_pre_battle.ps1", "w", encoding="utf-8") as f:
    f.write(ps_script)

res = subprocess.run(["powershell", "-ExecutionPolicy", "Bypass", "-File", "inspect_pre_battle.ps1"], capture_output=True, text=True)
print(res.stdout)

if os.path.exists("inspect_pre_battle.ps1"):
    os.remove("inspect_pre_battle.ps1")
