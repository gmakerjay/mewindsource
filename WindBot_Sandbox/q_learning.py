...
from shared_utils import (
    configure_utf8, get_sandbox_registry_path, save_registry_list,
...
def main():
    ...
    if not os.path.exists(reg_path):
        ...
        if os.path.exists(default_reg):
            ...
            print("Error: Default cards_registry.json not found in Sandbox.")
            sys.exit(1)
    ...
    for match_dir in match_dirs:
        ...
        # LP bonus/penalty: encourage keeping high LP
    ...
    print(f"Performed {update_count} Q-value updates in registry: {reg_path}")
