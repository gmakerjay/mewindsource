...
$type = $assembly.GetType("WindBot.Game.AI.Executor")
$method = $type.GetMethod("OnSelectAttacker", [System.Reflection.BindingFlags]::Public -bor [System.Reflection.BindingFlags]::Instance -bor [System.Reflection.BindingFlags]::NonPublic)
...
with open("inspect_on_select_attacker.ps1", "w", encoding="utf-8") as f:
    f.write(ps_script)

res = subprocess.run(["powershell", "-ExecutionPolicy", "Bypass", "-File", "inspect_on_select_attacker.ps1"], capture_output=True, text=True)
print(res.stdout)

if os.path.exists("inspect_on_select_attacker.ps1"):
    os.remove("inspect_on_select_attacker.ps1")
